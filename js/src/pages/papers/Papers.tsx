...
import PageComponent, { PageComponentProps, PageComponentState } from '@engine/containers/PageComponent';
import Request from '@engine/controllers/request';
import "./containers/papers.css"
...
export default class PapersPage extends PageComponent<PageComponentProps, PapersPageState> {
    ...
    protected submenu = "games";
    // Matches the backend papers page (RequiresAuth + RequiresAdmin); keeps it
    // out of the menu for guests/non-admins so it never 401s on click.
